...
train_transform, val_transform, val_corrupt_transform, _ = prepare_transforms()
    ...
    for iter_id in range(2):
        ...
        if iter_id > 0:
            ...
            if args.with_ssl:
                ...
                loss += (F.cross_entropy(logit, pseudo_label, reduction="none") * mask).mean() * loss_scale * 20.
